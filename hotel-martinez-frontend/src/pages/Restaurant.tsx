    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: 4, name: 'Тосты с авокадо и яйцом', price: '7.00€' },
          { id: 5, name: 'Сэндвич с листьями салата и помидорами', price: '6.50€' },
          {id: 6, name: 'Круассан с ореховой пастой', price: '4.00€' },
        ],
      },
      {
        category: 'Обед',
      ...
      },
      {
        ...
        items: [
          ...
          { id: 32, name: 'Капучино', price: '2.80€' },
        ],
      },
    ],
  },
